...
function Dashboard({ user, setUser }) {
  ...
  return (
    <div className='bg-[#09090F] min-h-screen text-[#F1F0FF] font-sans flex'>
      <Sidebar
        user={user}
      ...
      <motion.main className={`flex-1 min-h-screen px-3 sm:px-4 md:px-6 py-4 md:py-6 transition-all duration-300 ${sidebarOpen ? "md:ml-[260px]" : "md:ml-[72px]"
        ...
        <div className='flex items-center justify-between mb-5 md:mb-6'>
          <div className='flex items-center gap-2.5'>
            ...
            <motion.button
              ...
              className='md:hidden text-[#F1F0FF]/40 hover:text-violet-300 transition-colors'>
              <FiSidebar size={17} />
            ...
            >
              <p className='text-[#F1F0FF]/40 text-[11px] md:text-xs font-medium mb-0.5'>Overview</p>

              <h2 className='text-lg md:text-xl font-bold text-[#F1F0FF]'>Hello, {user?.name?.split(" ")[0]} 👋 </h2>
        ...
        <div className='h-px bg-violet-500/15 mb-5 md:mb-6' />
        ...
        initial={{ opacity: 0 }}
          ...
          className="mb-3 md:mb-4">
            ...
            <p className='text-violet-400/60 text-[10px] font-semibold uppercase tracking-widest mt-2.5 mb-1'>
            Performance</p>

            <h3 className='text-[#F1F0FF] font-bold text-sm md:text-base mb-3 md:mb-4'>Interview History</h3>
